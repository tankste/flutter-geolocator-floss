...
import 'package:geolocator_floss_platform_interface/src/implementations/method_channel_geolocator.dart';
  ...
  group('$MethodChannelGeolocator()', () {
    ...
    group('checkPermission: When checking for permission', () {
      test(
        ...
        // Arrange
        MethodChannelMock(
            channelName: 'flutter.baseflow.com/geolocator_floss',
