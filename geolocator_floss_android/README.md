...
More detailed instructions on using the API can be found in the [README.md](../geolocator_floss/README.md) of the [geolocator](https://pub.dev/packages/geolocator) package.
