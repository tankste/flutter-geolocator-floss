package com.baseflow.geolocator_floss;
...
import com.baseflow.geolocator_floss.errors.PermissionUndefinedException;
import com.baseflow.geolocator_floss.location.FlutterLocationServiceListener;
import com.baseflow.geolocator_floss.location.GeolocationManager;
import com.baseflow.geolocator_floss.location.LocationAccuracyStatus;
import com.baseflow.geolocator_floss.location.LocationAccuracyManager;
import com.baseflow.geolocator_floss.location.LocationClient;
import com.baseflow.geolocator_floss.location.LocationMapper;
import com.baseflow.geolocator_floss.location.LocationOptions;
import com.baseflow.geolocator_floss.permission.LocationPermission;
import com.baseflow.geolocator_floss.permission.PermissionManager;
import com.baseflow.geolocator_floss.utils.Utils;
...
class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
  ...
  void startListening(Context context, BinaryMessenger messenger) {
    ...
    channel = new MethodChannel(messenger, "flutter.baseflow.com/geolocator_floss_android");
