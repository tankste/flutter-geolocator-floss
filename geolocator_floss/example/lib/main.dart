...
/// Example [Widget] showing the functionalities of the geolocator_floss plugin
...
class _GeolocatorWidgetState extends State<GeolocatorWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return BaseflowPluginExample(
        ...
        githubURL: 'https://github.com/Baseflow/flutter-geolocator_floss',
        pubDevURL: 'https://pub.dev/packages/geolocator_floss',
        appBarActions: [
          _createActions()
        ],
        pages: [
